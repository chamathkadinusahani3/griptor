      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          <Reveal key={i} delay={i * 0.05}>
              ...
              className="group relative p-6 bg-white rounded-2xl border border-[var(--border)] shadow-sm hover:shadow-xl hover:shadow-[var(--teal)]/10 transition-all duration-300 overflow-hidden">
